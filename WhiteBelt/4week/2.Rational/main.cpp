	    ...
	    cout << "OK" << endl;
	    {
	        ...
	        cout << "OK" << endl;
	        {
	            ...
	            cout << "OK" << endl;
	            {
	                    ...
	                    output << Rational(-6, 8);
	                    if (output.str() != "-3/4") {
	                        cout << "Rational(-6, 8) should be written as \"-3/4\"" << " 1" << endl;
	                        return 1;
	                    }
	                }

	                {
	                    ...
	                    if (!equal) {
	                        cout << "5/7 is incorrectly read as " << r << " 2" << endl;
	                        return 2;
	                    }
	                }

	                {
	                    ...
	                    if (!correct) {
	                        cout << "Read from empty stream works incorrectly" << " 3" << endl;
	                        return 3;
	                    }
	                }

	                {
	                    ...
	                    if (!correct) {
	                        cout << "Multiple values are read incorrectly: " << r1 << " " << r2 << " 4" << endl;
	                        return 4;
	                    }
	                    ...
	                    if (!correct) {
	                        cout << "Read from empty stream shouldn't change arguments: " << r1 << " " << r2 << " 5" << endl;
	                        return 5;
	                    }
	                }
	                ...
	                cout << "OK" << endl;
	                {
	                        ...
	                        if (rs.size() != 3) {
	                            cout << "Wrong amount of items in the set" << " -1" << endl;
	                            return 1;
	                        }
	                        ...
	                        if (v != vector<Rational>{{1, 25}, {1, 2}, {3, 4}}) {
	                            cout << "Rationals comparison works incorrectly" << " -2" << endl;
	                            return 2;
	                        }
	                    }

	                    {
	                        ...
	                        if (count.size() != 2) {
	                            cout << "Wrong amount of items in the map" << " -3" << endl;
	                            return 3;
	                        }
	                    }
